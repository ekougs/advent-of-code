...
fn main() {
    ...
    // 2023
    // Day 1
    println!("Trebuchet {}", trebuchet::calibrate_using_digits("trebuchet_input.txt"));
    println!("Trebuchet with letters {}", trebuchet::calibrate_using_letters_and_digits("trebuchet_input.txt"));
